  ...
  return (
    <div>
      ...
      <Form.Group className="d-flex mt-3">
        ...
        <Form.Label htmlFor="pickUp-location01" className="ms-2">
          Mon. 8:00 A.M. AAA Station
        </Form.Label>
      </Form.Group>
      <Form.Group className="d-flex">
        <Form.Check type="radio" id="pickUp-location02" />
        <Form.Label htmlFor="pickUp-location02" className="ms-2">
          Mon. 8:00 A.M. AAA Station
        </Form.Label>
      </Form.Group>
      <Form.Group className="d-flex">
        <Form.Check type="radio" id="pickUp-location03" />
        <Form.Label htmlFor="pickUp-location03" className="ms-2">
          Mon. 8:00 A.M. AAA Station
        </Form.Label>
      </Form.Group>
    </div>
